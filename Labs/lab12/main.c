...
int main() {
    ...
    /* Dynamically open the shared library libsum.so. If it fails,
    ...
    /* Get a pointer to the sum_array() function we just loaded. If it
    ...
    */
    ...
    /* Close the shared library.  If it fails, print the system-generated
