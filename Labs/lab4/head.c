...
int main(int argc, char *argv[]) {
    ...
    /* Use the system call open() to open the src_file for reading.
    ...
    while ((bytes_read = read(src_fd, buf, BUFSIZE)) > 0 && index != line_count) {
        buf[bytes_read] = '\0';
   ...
   /* Close the file. Free up resources, if necessary. */
